"""
helper-streamlit-utils PyPI 업로드 스크립트

사용법:
    python upload_helper_streamlit_utils.py [--test]
...
def main():
    ...
    if test_mode:
        ...
        print("   pip install --index-url https://test.pypi.org/simple/ helper-streamlit-utils")
    else:
        print("PyPI에서 설치:")
        print("   pip install helper-streamlit-utils")
